...
# 7. FIRST-RUN BOOTSTRAP — Keyboard Layout
# Generates the snippet sourced by hyprland/modules/input.conf
KB_CONF="$HOME/.config/hypr/modules/keyboard.conf"
mkdir -p "$HOME/.config/hypr/modules"

print_step ">> Configuring Keyboard Layout ($KB_LAYOUT)..."
cat > "$KB_CONF" << EOF
# Auto-generated by installer based on profile.conf
# Do NOT edit manually — re-run the installer to change layout.
input {
